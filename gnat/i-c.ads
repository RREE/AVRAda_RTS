...
--  use with AVR-Ada.  It only contains some useful type definitions,
--  no conversion routines.
--
--  In accordance with the copyright of that document, you can freely
--  copy and modify this specification, provided that if you
--  redistribute a modified version, any changes that you have made
...
package Interfaces.C is
   ...
   --  a non-private system.address type as in AVR-Ada's system.ads.
